...
These are related but NOT interchangeable. Never assume code == channel_name
(see "immigration" -> channel "help-desk" for the one exception in this map).
"""
...
LOCATIONS = {
    ...
    "lekki": {"name": "Lekki Phase 1", "channel": "lekki", "zone": "island",
              "roles": ["Lekki resident", "Island visitor"]},
    "ikoyi": {"name": "Ikoyi Waterfall Villa", "channel": "ikoyi", "zone": "island",
              "roles": ["Ikoyi resident", "Island visitor"]},
    "eko-atlantic": {"name": "Eko Atlantic Penthouse", "channel": "eko-atlantic", "zone": "island",
                      "roles": ["Eko Atlantic resident", "Island visitor"]},
    "mayor-villa": {"name": "Mayor's Penthouse", "channel": "mayor-villa", "zone": "island",
                     "roles": ["Presidential Villa resident", "Presidential Villa visitor"]},
    "deputy-villa": {"name": "Deputy's Residence", "channel": "deputy-villa", "zone": "island",
                      "roles": ["Presidential Villa resident", "Presidential Villa visitor"]},
    "guesthouse1": {"name": "Villa Guesthouse 1", "channel": "guesthouse1", "zone": "island",
                     "roles": ["Presidential Villa resident", "Presidential Villa visitor"]},
    "guesthouse2": {"name": "Villa Guesthouse 2", "channel": "guesthouse2", "zone": "island",
                     "roles": ["Presidential Villa resident", "Presidential Villa visitor"]},
    "cos": {"name": "Chief of Staff", "channel": "cos", "zone": "island",
            "roles": ["Eko chiefs", "Eko deputies", "government officials"]},
    "council": {"name": "Eko Council", "channel": "council", "zone": "island",
                "roles": ["Eko chiefs", "Eko deputies", "government officials"]},
    "justice": {"name": "Ministry of Justice", "channel": "justice", "zone": "island",
                "roles": ["Eko chiefs", "Eko deputies", "government officials"]},
    "housing": {"name": "Ministry of Home Affairs & Housing", "channel": "housing", "zone": "island",
                "roles": ["Eko chiefs", "Eko deputies", "government officials"]},
    "agriculture": {"name": "Ministry of Agriculture", "channel": "agriculture", "zone": "island",
                     "roles": ["Eko chiefs", "Eko deputies", "government officials"]},
    "clerk": {"name": "Clerk Office", "channel": "clerk", "zone": "island", "roles": None},
    "bank": {"name": "Central Bank of Eko", "channel": "bank", "zone": "island", "roles": None},
    "hospital": {"name": "Eko Medical Service", "channel": "hospital", "zone": "island", "roles": None},
    "police": {"name": "Eko Police Department", "channel": "police", "zone": "island", "roles": None},
    "rental": {"name": "Property Development Department", "channel": "rental", "zone": "island", "roles": None},
    "university": {"name": "Eko Metropolis University", "channel": "university", "zone": "island", "roles": None},
    "lobby": {"name": "Eko Lobby", "channel": "lobby", "zone": "island", "roles": None},
    "clubhouse": {"name": "Eko Clubhouse", "channel": "clubhouse", "zone": "island", "roles": None},
    "chapel": {"name": "Eko City Chapel", "channel": "chapel", "zone": "island", "roles": None},

    # ---- Mainland zone hub ----
    "mainland": {"name": "Third Mainland Bridge", "channel": "3rd-mainland-bridge", "zone": "mainland", "roles": None},
    "ikeja": {"name": "Ikeja Estate", "channel": "ikeja", "zone": "mainland",
              "roles": ["Ikeja resident", "Mainland visitor"]},
    "yaba": {"name": "Yaba Estate", "channel": "yaba", "zone": "mainland",
             "roles": ["Yaba resident", "Mainland visitor"]},
    "surulere": {"name": "Surulere Estate", "channel": "surulere", "zone": "mainland",
    ...
    "depot": {"name": "Depot", "channel": "depot", "zone": "mainland", "roles": None},
    "dealership": {"name": "Vehicle Dealership", "channel": "dealership", "zone": "mainland", "roles": None},
    "taxi": {"name": "Taxi Company", "channel": "taxi", "zone": "mainland", "roles": None},
    "repair": {"name": "Automobile Repair", "channel": "repair", "zone": "mainland", "roles": None},
    "agency": {"name": "Travel Agency", "channel": "agency", "zone": "mainland", "roles": None},
    ...
    "tenement": {"name": "Face Me I Face You", "channel": "tenement", "zone": "ghetto", "roles": ["Tenement resident"]},

    # ---- Farmland zone hub ----
    "farmland": {"name": "Farmland", "channel": "farmland", "zone": "farmland", "roles": None},

    # ---- Overseas (not road-reachable) ----
    "dubai": {"name": "Dubai", "channel": "dubai", "zone": "overseas", "roles": None},
    "maldives": {"name": "Maldives", "channel": "maldives", "zone": "overseas", "roles": None},
}
