...
COGS = [
    ...
    # Phase 2 banking (!create-account, !with, !transfer,
    # !cash-bal, !pay, !view-balances, !cb-with, !adjust). Loads
    # after cogs.location_admin since its sub-location gates
    # (front-desk/atm/cbe-chairman) depend on those rooms already
    # being registrable, though there's no hard import dependency.
    "cogs.banking",
