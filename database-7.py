...
def reset_database() -> int:
    ...
    NOT reset by this function, deliberately:
        `locations` and `sub_locations` — registered locations
        (including businesses) and their attached sub-locations
        must survive a database reset. There is no DELETE for
