...
#      -> pings the nearest online, idle driver of that tier. If
#         nobody is free, the booker is placed in a FIFO queue
#         for that tier (TAXI_QUEUE_TIMEOUT_SECONDS wait limit)
#         and is auto-matched the moment a driver of that tier
#         comes online, finishes a trip, declines, or times out.
#
...
#         TAXI_REQUEST_TIMEOUT_SECONDS. A decline or a timeout
#         both trigger an automatic rematch/re-queue, same as
#         if no driver had been found in the first place.
#
