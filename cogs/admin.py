...
class AdminCog(commands.Cog):
    ...
    async def registerplayers(
        ...
        for member in ctx.guild.members:
            ...
            # Bank accounts are NOT opened here (Phase 2). A
            # player has to walk into the front desk and run
            # !create-account themselves — or have a teller do it
            # for them — same as everything else that's gone from
