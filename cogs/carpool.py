...
async def handle_arrival(
    ...
    advances. No-op unless the car has just reached a queued
    passenger's drop-off point.
    """
    ...
    # Remove it immediately so it can never fire twice.
    stops.remove(marker)
