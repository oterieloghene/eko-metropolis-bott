...
class StatsCog(commands.Cog):
    ...
    async def decay_stats(self):
        ...
        from cogs.weather import get_passive_stat_multiplier
        from cogs.daynight import get_passive_stat_multiplier as get_night_passive_stat_multiplier
        ...
        for user_id in database.all_player_ids():
            ...
            deltas = {
                stat_name: (
                    value
                    * get_passive_stat_multiplier(stat_name)
                    * get_night_passive_stat_multiplier(stat_name)
                )
                for stat_name, value in STAT_DECAY_PER_TICK.items()
            }
